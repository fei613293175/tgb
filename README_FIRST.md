...
- 旧“41 类前端页面”统计已于 2026-07-27 失效：其中混入直接 URL、源码路由和隐藏控件；当前正按 `16_RUNTIME_CLICK_AUDIT.md` 从生产可见入口重建真实点击图。
...
- `R06`、`R07`、`R08` 已完成；增长、奖励和站内 App 下载页的 R08 最终 15 个手机视口用例全部通过。
- 当前版本：`R09`，状态：`IN_PROGRESS`。
- 当前唯一任务：全站最终复核和上线准备；`xigua_hs`、`xigua_sp`、`tb_jjd`、广告、淘金等没有真实前端入口的插件继续保持视觉范围外，不再开发隐藏页面。
