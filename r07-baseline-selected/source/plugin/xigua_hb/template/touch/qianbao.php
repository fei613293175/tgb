...
<div id="header" style="margin-top:0px;">
    ...
    <a href="javascript:window.history.go(-1);">
        <img style="margin-top: 25px;" src="https://img.imehui.com/20250117/1737108696678a2cd8a7344.png" alt="返回图标" width="20" height="20">
    </a>
    <!-- 标题 -->
...
<div class="selection">
    <a href='plugin.php?id=xigua_hb&ac=mytx&from=&idu=1'>
        <div style="font-size:14px;color:#8b6f5c;">
            <img style="vertical-align: middle;padding-top:-2px;" src="https://img.imehui.com/20240613/1718283142666aeb86e0e09.png" alt="" height="17" width="17">
            提现到
...
<!--{else}-->
<div style="text-align:center;margin-top:20px;color:#8b6f5c;vertical-align:middle;">
    未绑定提现方式
...
<div style="text-align: left;margin-top: 10px;font-size: 14px;background: rgba(255,255,255,0.85);backdrop-filter: blur(20px);-webkit-backdrop-filter: blur(20px);border-radius:24px;padding:20px;margin:15px;color:#8b6f5c;border:1px solid rgba(255,190,90,0.35);box-shadow: 0 20px 45px rgba(255,140,30,0.10);">
    <p>1、签米会员提现服务费永久7%，推荐开通会员提现更划算；</p>
