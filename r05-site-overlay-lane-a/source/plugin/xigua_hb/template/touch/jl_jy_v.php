...
<script>document.documentElement.classList.add('tgb-r05-detail-page');</script>
    ...
    <div>
        <div class="weui-flex" style="margin-top: -71px; position: fixed; background: rgba(255,255,255,0.85); backdrop-filter: blur(22px); -webkit-backdrop-filter: blur(22px); z-index: 9999; width: 100%; height: 90px; border-bottom: 1px solid rgba(255,200,120,0.35); box-shadow: 0 2px 20px rgba(255,150,30,0.06);">
            <a href="javascript:history.go(-1)" class="weui-flex__item view-header-left" style="margin-top: 42px;">
                <img style="margin-top: 15px;margin-left:15px;" src="https://img.imehui.com/20251215/1765731723693eed8bcd901.png" alt="返回图标" width="20" height="20">
                <i class="bi bi-chevron-left" style="color: #b08968; margin-left:-20px;"></i>
            </a>
            ...
            <div class="weui-flex__item view-header-right" style="margin-top: 57px; font-size: 12px; color: #b08968; margin-right: 20px;">
                <a href="plugin.php?id=xigua_hj">
                    <img style="width:15px;height:15px;margin-top:-3px;vertical-align:middle;" src="https://img.imehui.com/20250919/175822783368cc6d79aa6f2.png" /> 举报
                </a>
            </div>
        </div>
        ...
        <div id="header" style="margin-top:0px;">
            <a href="javascript:window.history.go(-1);">
                <img style="margin-top: 52px;" src="https://img.imehui.com/20250919/175827202768cd1a1b5dc6e.png" alt="返回图标" width="20" height="20">
            </a>
            ...
            <div class="crypto-user-card crypto-glass">
                <div class="crypto-user-info">
                    <div class="crypto-avatar-section">
                        ...
                        <img class="crypto-badge-director" src="https://img.imehui.com/20240530/171704676166580de99d0bf.png" alt="董事代理">
                        {/if}-->
                    </div>
