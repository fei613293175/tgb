...
<script>document.documentElement.classList.add('tgb-r05-member-page');</script>
<!--{if $_GET['app']}--><style>.yu_sidectrl, .yu_weui, .yu_line,.yu_top,.x_header,.my__head,.yu_top_avatar{display:none}</style><!--{/if}-->
<div class="page__bd tgb-r05-member">

<!--{if !$_GET['app']}-->
    <a class="yu_sidectrl mem_ctrl1" href="javascript:void(0)"><img style="margin-top:30px;" src="https://img.imehui.com/20250131/1738254658679ba942bd984.png" alt=""></a>
  
<!--{/if}-->
 
        <img style="width:100%;height:100%;" src="https://img.imehui.com/20250919/175822898968cc71fdea9f8.jpeg">
