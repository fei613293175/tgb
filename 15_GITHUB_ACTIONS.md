...
文档状态：R01 首次全绿远程运行与 Artifact 人工复核已完成
...
R01 原生容器先于 R02/R03 H5 品牌改造完成，因此首个全绿 run 允许把当前生产
H5 的旧品牌/旧视觉登记为明确 OPEN，但不能把它写成视觉通过。自 R02/R03 相应
页面进入改造后，“推广宝”和新浅色体系是阻断性门禁，最终 R09 不允许保留该 OPEN。
