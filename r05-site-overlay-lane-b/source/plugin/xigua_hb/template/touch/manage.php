...
.page__bd #list .cmt-wrap, .page__bd #list .cmt-list, .page__bd #list .r { border-color:#d8e1ec!important; background:#edf3fa!important; color:#405166!important; }
.page__bd #list img, .page__bd #list video { max-width:100%; }
.page__bd #list .mod-feed-text, .page__bd #list .view-content-comment-text, .page__bd #list .time, .page__bd #list .ipadr, .page__bd #list .da { overflow-wrap:anywhere; word-break:break-word; }
