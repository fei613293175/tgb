...
<head>
    ...
    <link href="source/plugin/xigua_member/images/tgb-r06-profile-light-grid.css?v=1" type="text/css" rel="stylesheet" />
...
<!--        <a class="home-return" href="home.php?mod=spacecp&amp;ac=profile&amp;op=base&amp;mobile=2" style="right: 0;left: auto;">��������</a>-->
    ...
    <div class="divbtn" style="margin:15px;border-radius:8px;">
        <table class="sec" style="border-radius:8px;">
        ...
        <tr>
            ...
            <td>
                <p>
                    <input type="password" style="border-radius:8px;" autocomplete="off" class="input" name="password" value="" placeholder="<?php xul('password_tip')?>" />
                </p>
            </td>
        </tr>
    ...
    <div class="divbtn mt10">
        <input class="btn1" style="border-radius:8px;padding:10px 10px;width:90%;background-color:#fff;" type="submit" name="dosubmit" id="dosubmit" value="<?php xul('save')?>" />
    </div>
</div>
</form>
