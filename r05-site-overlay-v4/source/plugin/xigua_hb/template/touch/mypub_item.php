...
<div class="po-cmt">
    ...
    <div style="width:170px;height:80px;z-index:9999;background:#edf3fa!important;border:1px solid #bfd0e3;color:#2176c7!important;margin-top:0;font-size:10px;text-align:left;" class="abs  mod-feed-tag main_color">
        <div style="overflow-y: scroll;height: 95%;">
        <!--{if $v[uid] == $_G['uid'] }-->
        <a class=" weui-btn_mini mt0" style="border-radius:8px;color:#fff!important;background:#2764ff!important;width:76px!important;font-size:12px;margin-top:-10px;" href="plugin.php?id=xigua_hb&ac=pub&step=3&edit=$v[id]">立即修改 </a>
        <!--{/if}-->      
            </p>
        $v[reason]
</div>
...
<!--{/if}-->
            ...
            <div class="listdata-card-bottom" style="position:relative;padding-top:0px;margin-bottom:1px;color: #f1f1f1;">
               ...
               <span class="" style="vertical-align:middle;margin-right:5px;color:#0e1b2a;font-size:14px;font-weight:400;margin-top:35px!important;">
    <i class="tgb-r05-traffic-mark" aria-hidden="true"></i>
    已获得 {$v[views]} 流量
</span>

                           
                <span  style="padding:2px 5px;float:right;font-weight:normal;font-size:14px;color:#2764ff;overflow:hidden;">
                             {$v[time_u]}更新排名
                            </span>
            </div>
...
<div class="opqy" style="margin-top:0px;">
    <a class="weui-btn weui-btn_mini p0 mt0  btn-new01" style="border:1px solid #2764ff!important;vertical-align:middle;border-radius:8px;background:#2764ff!important;color:#fff!important;margin-left:5px;" href="javascript:;" onclick="hb_dig('$v[id]');"><!--{if $v[zdword]}-->$v[zdword]<!--{else}-->置顶<!--{/if}--></a>
    <a class="weui-btn weui-btn_mini p0 mt0  btn-new01" style="border:1px solid #2764ff!important;vertical-align:middle;background:#2764ff!important;color:#fff!important;" href="javascript:;" onclick="hb_shuaxin('$v[id]','$cats[$v[catid]][shuxin]');">刷新</a>
...
<div class="po-cmt">
    ...
    <div style="max-width: 7rem;z-index: 501;background-image: linear-gradient(90deg, #f1f4fb 1%, #f1f4fb 99%)!important;border:1px solid #3167ee;color:#3167ee;text-align: left;" class="abs  mod-feed-tag main_color">$v[reason]
        ...
        <!--{if $v[uid] == $_G['uid'] }-->
        <a class=" weui-btn_mini mt0" style="border-radius:8px;color:#fff!important;background-color:#2764ff!important;width:76px!important;font-size:12px;" href="plugin.php?id=xigua_hb&ac=pub&step=3&edit=$v[id]">立即修改 </a>
        <!--{/if}-->
