...
<header class="x_header bgcolor_11 cl f15" style="background: rgba(255,255,255,0.85) !important; backdrop-filter: blur(22px); border-bottom: 1px solid rgba(255,200,120,0.35) !important; height: 60px; box-shadow: 0 2px 20px rgba(255,150,30,0.06);">
    <div style="margin-top:15px;"> </div>
    <a class="z " style="height:50px;line-height: 25px;" href="javascript:window.history.go(-1);"><img style="margin-left: -10px;margin-top:6px;height:20px;" src="https://img.imehui.com/20251215/1765731723693eed8bcd901.png"></i></a>
    <div style="font-weight:800;font-size:20px;text-align:center;color:#3d2b1a;margin-top:2px;">发布项目</div>
...
<div class="page__bd" style="margin-top:70px;border-radius:0px!important;margin:0px;background-color:transparent;font-size:15px;font-weight:400;color:#3d2b1a!important;">
...
<div class="crypto-vip-promo" style="border-radius:16px; margin:15px; text-align:center;">
    ...
    <div class="crypto-vip-text">
        <span class="crypto-vip-title">签米会员，解锁上传图片特权 <a href="plugin.php?id=xigua_hb&ac=vip" class="crypto-vip-btn">
            立即开通
        </a></span>
...
<div class="crypto-vip-promo" style="border-radius:16px; margin:15px; text-align:center;">
    ...
    <div class="crypto-vip-text">
        <span class="crypto-vip-title">签米会员，解锁留联系方式特权 <a href="plugin.php?id=xigua_hb&ac=vip" class="crypto-vip-btn">
            立即开通
        </a></span>
...
<div id="pubdig" style="display:none;">
    <div class="weui-cells weui-cells_form before_none after_none" style="border-radius: 2rem;">
        <div class="weui-cell weui-cell_switch before_none">
            <div class="weui-cell__hd">
                <img src="https://img.imehui.com/20240416/1713265714661e5c329bdbd.png" style="width:22px;display:block">
            </div>
        ...
        <div class="dig_pub_exts cl" style="border-radius:20px;">
            ...
            <label class=" <!--{if $tmp_dig[price]<=0}-->none1 <!--{/if}--><!--{if $config[longcard]==2}-->longdig<!--{/if}--> dig_pub_div cl <!--{if !$actv_has && $tmp_dig[price]>=0}-->active<!--{eval $actv_has=1;}--><!--{/if}--> " for="dig_pub_$_k" style="border-radius:20px 20px 0px 20px;">
                <!--{if $tmp_dig[tgg]}-->
                <div class="dig_pub_subtag main_bg" style="background: linear-gradient(135deg, #ff7b00, #e63946) !important;">{$tmp_dig[tgg]}</div>
                <!--{/if}-->
                <div class="pubdigo">
                    <div class="dig_pub_title" style="font-size:13px;font-weight:600;">{$tmp_dig[shorttitle]}</div>
                    <div class="dig_pub_price main_color" style="font-size:19px;font-weight:700;color: #d35400 !important;" data-dpr="{$tmp_dig[price]}"><em>&yen;</em>{$tmp_dig[price]}</div>
...
<div id="pubred" style="display:none;">
    <div class="weui-cell weui-cell_switch">
        <div class="weui-cell__hd">
            <img src="https://img.imehui.com/20240416/1713265841661e5cb19e68e.png" style="width:25px;display:block">
        </div>
    ...
    <div class="redb_exts cl" ><!--{eval $actv_has2=0;}-->
        ...
        <label class="<!--{if $config[longcard]==2}-->longdig<!--{/if}--> redb_div cl <!--{if !$actv_has2}-->active<!--{eval $actv_has2=1;}--><!--{/if}--> " for="redb_$_k"  style="border-radius:20px 20px 0px 20px;">
            <div class="pubdigo">
                ...
                <div class="redb_price main_color" style="font-size:19px;font-weight:700;color: #d35400 !important;" data-dpr="{$item[price]}"><em>&yen;</em>{$item[price]}</div>
