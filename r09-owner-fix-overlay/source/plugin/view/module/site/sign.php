...
$tgbAndroidApp = strpos($_SERVER['HTTP_USER_AGENT'] ?? '', 'TuiGuangBaoAndroid/') !== false;
?>
<!DOCTYPE html>
<html class="<?= $tgbAndroidApp ? 'tgb-android-app' : '' ?>" lang="zh-CN">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover">
    <title>推广宝 · 签到中心</title>
...
<div class="container">
    ...
    <div class="sign-zone" style="margin-bottom:20px;">
        ...
        <div class="sign-status">
            ...
            <?php else: ?>
                <?php echo $isVip ? '<span style="color:#d4af37;font-weight:800;">推广宝会员尊享</span>' : '普通用户'; ?>
    ...
    <div class="vip-card" onclick="location.href='plugin.php?id=xigua_hb&ac=vip'">
        ...
        <div class="vip-info">
            <div class="vip-title">升级推广宝会员 · 赚更多</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var noticeList = [
        ...
        {
            id: 2,
            title: '推广宝刚刚上线，截止29日凌晨已突破8万人注册，团队长速度布局！',
            date: '2026-05-29',
    ...
    function openRuleModal(type) {
        if (type === 'play') {
            ...
            <div class="rule-modal-grid" style="margin-top:0;">
                ...
                <div class="rule-modal-card"><i class="ri-vip-crown-line" style="background: linear-gradient(135deg, #f0b90b, #ffd700); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"></i><div>推广宝会员签到<br><b>+25.00元</b></div></div>
            ...
            json('plugin.php?id=view&modac=sign&submodac=promo_info', function(res) {
                if (res.code === 0) {
                    ...
                    <div class="promo-intro">
                        ...
                        <br><b>推广宝会员特权：</b>若好友是推广宝会员，每次签到您都可获得提成奖励；若好友不是推广宝会员，每位好友最多为您提供2次签到奖励。
                        <br>
                        <b>如何提高奖励？</b><br>
    ...
    function startSign() {
        ...
        json('plugin.php?id=view&modac=sign&submodac=status', function(res) {
            ...
            if (!res.is_vip) {
                showConfirm('升级会员奖励加倍', '开通推广宝会员后，每日签到可领<b style="font-size:20px;color:#ff7b00;"> 25 元</b>！<br>早升级早赚钱！', [
