...
<div style="margin-top: 125px; background: transparent;">
    <div class="feed-list tgb-headline-feed">
        ...
        <!-- 全新卡片设计：极简留白 · 鼠尾草主题 -->
        <article class="post-card tgb-headline-card">
            <!-- 作者信息区：左图右文，清爽分隔 -->
            <div class="post-author">
                <a href="#">
                    ...
                    <div class="author-info">
                        <div class="tgb-headline-author-row">
                            <strong>$_v['realname']</strong>
                            <span class="tgb-headline-badge">头条</span>
                        </div>
                        <div class="tgb-headline-time-row">
                            <span>
            ...
            <div class="post-content">
                <h2>
                    <a href="plugin.php?id=xigua_hb&ac=view&pubid={$_v[id]}">
...
<link rel="stylesheet" href="source/plugin/xigua_hb/static/tgb-r04/discovery-light-grid-r04.css?v=20260728-owner-v9">
<!--{template xigua_hb:common_footer}-->
<script src="source/plugin/xigua_hb/static/tgb-r04/discovery-r04.js?v=20260728-owner-v9"></script>
