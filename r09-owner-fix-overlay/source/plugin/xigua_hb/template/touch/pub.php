...
.tgb-android-app header.x_header {
...
.tgb-android-app header.x_header a.z,
.tgb-android-app header.x_header a#submitnew { top:calc(8px + env(safe-area-inset-top,0px))!important; }
.crypto-upload-container { padding-top:14px!important; }
.crypto-input-group { margin-top:10px!important; margin-bottom:10px!important; }
.vars_cells { margin-top:12px!important; }
