...
<body class="tgb-growth-page tgb-invite-page">
    <!-- Toast -->
    ...
    <div class="growth-shell">
        ...
        <header class="growth-header">
            <div class="growth-titlebar">
                <a href="plugin.php?id=xigua_hb&ac=my" class="growth-back" aria-label="返回个人中心">
                    <i class="ri-arrow-left-line"></i>
                </a>
                <div class="growth-heading"><span>推广宝</span><h1>邀请好友</h1></div>
                <div class="growth-team-link" aria-hidden="true"><i class="ri-group-line"></i></div>
            </div>

            <!-- 三列数据统计 -->
            <div class="growth-stats growth-stats-three">
                <div class="stat-card">
        ...
        <nav class="growth-tabs">
            <button class="tab-btn active" id="tabReward" onclick="switchTab('reward')">
                <i class="ri-gift-line"></i>奖励机制
            </button>
            <button class="tab-btn" id="tabRule" onclick="switchTab('rule')">
                <i class="ri-book-open-line"></i>推广规则
            </button>
        </nav>
        ...
        <div class="growth-content">
            ...
            <div id="panelReward" class="tab-panel">
                ...
                <div class="reward-grid">
                    ...
                    <!-- 卡片3：VIP奖励 -->
                    <div class="reward-card reward-card-vip">
        ...
        <footer class="growth-actions">
            ...
            <div class="flex gap-3">
                <button onclick="showpic('{$invitetpl[0]}')" class="btn-primary flex-1" style="white-space:nowrap;">
                    <i class="ri-qr-code-line"></i> 获取邀请海报
                </button>
    ...
    <div id="posterModal" class="fixed inset-0 modal-overlay z-50 hidden items-center justify-center p-5" style="display:none;">
        <div class="modal-panel">
            <div class="modal-head">
                <h3>我的邀请海报</h3>
                <button id="closePosterBtn" class="modal-close" aria-label="关闭">
            ...
            <div class="modal-body">
                <div class="poster-preview">
                    <div class="poster-image">
                        <img src=" " alt="推广宝邀请二维码">
                    </div>
                    <h4>推广宝 · 邀请好友</h4>
                    <p>扫描二维码，立即注册</p>
                </div>
                <button id="savePosterBtn" class="btn-primary modal-save">
    ...
    <div id="bindcode_tmpl" style="display:none;z-index:9999999;">
        <div style="padding: 14px;">
            ...
            <input placeholder="请输入上级给你的邀请码" type="text" id="ymcode" class="bind-code-input" style="margin-top:4px;">
        </div>
    </div>

    <!-- 海报图片容器 -->
    <div id="showqrpic_tmpl" style="display: none">
        <div><img class="qr-image" id="showqrpic"></div>
    </div>
