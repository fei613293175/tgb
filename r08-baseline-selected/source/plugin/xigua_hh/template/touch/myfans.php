...
<head>
    ...
    <!-- 配置Tailwind - 暖白珊瑚红渐变配色 -->
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        'crypto-primary': '#ff7b00',      // 主色
                        'crypto-secondary': '#e63946',    // 辅色
                        'crypto-accent': '#ff7b00',       // 强调
                        'crypto-dark': '#fff9f5',
                    ...
                    fontFamily: {
                        sans: ['-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'PingFang SC', 'Helvetica Neue', 'sans-serif'],
                    },
                    boxShadow: {
...
<body class="crypto-gradient-bg min-h-screen">
    <!-- 头部栏 -->
    ...
    <div class="page__bd" style="margin-top:106px; padding: 0 16px;">
        
          <div style="color:#8b6f5c;font-size:14px;text-align:center;padding:10px;margin:0 0px;border-radius:40px;background: rgba(255, 245, 235, 0.7);margin-bottom:10px;border: 1px solid rgba(255, 200, 120, 0.35);">统计数据1小时更新1次</div>
       <!-- 统计数据卡片 -->
<div class="stats-container">
    ...
    <div class="stat-item stat-item-secondary">
        ...
        <div style="color:#8b6f5c;font-size:14px;text-align:center;padding:10px;margin:0 0px;border-radius:40px;background:rgba(255, 245, 235, 0.7);margin-bottom:10px;border:1px solid rgba(255, 200, 120, 0.35);">点击好友头像可私信联系对方</div>
       
    <div id="list" class="weui-cells p0 before_none" style="margin:0px;border-radius:10px;color:#3d2b1a;font-weight:550;background-color:#fff0;margin-left:-10px;margin-right:-10px;">
